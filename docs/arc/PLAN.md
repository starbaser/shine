...
- [Shine - Development Plan](#shine-development-plan)
  - [Executive Summary](#executive-summary)
  - [Architecture Decision](#architecture-decision)
    - [Why Kitty Panel?](#why-kitty-panel)
  - [What We're Building](#what-were-building)
    - [Phase 1: Prototype (Current)](#phase-1-prototype-current)
    - [Phase 2: Expansion (Future)](#phase-2-expansion-future)
  - [Project Structure](#project-structure)
  - [Key Implementation Details](#key-implementation-details)
    - [1. Panel Configuration (pkg/panel/config.go)](#1-panel-configuration-pkgpanelconfiggo)
    - [2. Panel Manager (pkg/panel/manager.go)](#2-panel-manager-pkgpanelmanagergo)
    - [3. Remote Control Client (pkg/panel/remote.go)](#3-remote-control-client-pkgpanelremotego)
    - [4. Configuration System (pkg/config/)](#4-configuration-system-pkgconfig)
    - [5. Main Launcher (cmd/shine/main.go)](#5-main-launcher-cmdshinemaingo)
    - [6. Control Utility (cmd/shinectl/main.go)](#6-control-utility-cmdshinectlmaingo)
    - [7. Chat Component (cmd/shine-chat/main.go)](#7-chat-component-cmdshine-chatmaingo)
  ...
  - [Configuration](#configuration)
    - [User Config Location](#user-config-location)
    - [Example Configuration](#example-configuration)
    - [Configuration Reference](#configuration-reference)
  - [Usage Examples](#usage-examples)
    - [Launch All Configured Panels](#launch-all-configured-panels)
  ...
  - [Technical Decisions & Rationale](#technical-decisions-rationale)
    - [Why Not Direct Wayland Bindings?](#why-not-direct-wayland-bindings)
    - [Why Not Build Custom Terminal Renderer?](#why-not-build-custom-terminal-renderer)
    - [Why Go Instead of Rust/Python?](#why-go-instead-of-rustpython)
    - [Component as Separate Binaries vs. Single Binary](#component-as-separate-binaries-vs-single-binary)
  - [Known Limitations](#known-limitations)
    - [Prototype (Phase 1)](#prototype-phase-1)
    - [Architecture](#architecture)
  - [Success Criteria](#success-criteria)
    - [Phase 1 (Prototype)](#phase-1-prototype)
    - [Phase 2 (Expansion)](#phase-2-expansion)
  - [Next Steps](#next-steps)
    - [Immediate (Prototype Implementation)](#immediate-prototype-implementation)
    - [Short Term (Post-Prototype)](#short-term-post-prototype)
    - [Long Term (Phase 2)](#long-term-phase-2)
  - [Reference Documentation](#reference-documentation)
    - [Research Documents](#research-documents)
    - [Charm Ecosystem](#charm-ecosystem)
    - [Example Code](#example-code)
    - [Kitty Source References](#kitty-source-references)
  - [Questions & Decisions Log](#questions-decisions-log)
    - [Q: Should components be Go plugins or separate binaries?](#q-should-components-be-go-plugins-or-separate-binaries)
    - [Q: How do we handle component discovery?](#q-how-do-we-handle-component-discovery)
    - [Q: What about users without Kitty?](#q-what-about-users-without-kitty)
    - [Q: Can components use non-TUI rendering?](#q-can-components-use-non-tui-rendering)
    - [Q: How to handle component crashes?](#q-how-to-handle-component-crashes)
    - [Q: Declarative widgets in Phase 2 - how?](#q-declarative-widgets-in-phase-2-how)
  - [Glossary](#glossary)
  - [Appendix: Kitty Panel CLI Reference](#appendix-kitty-panel-cli-reference)
  <!--toc:end-->
