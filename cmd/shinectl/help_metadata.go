...
var helpRegistry = map[string]*CommandHelp{
	...
	"config": {
		...
		Usage:    "shinectl -config PATH",
		Content:  configHelp,
		Related:  []string{"signals"},
		SeeAlso:  []string{"prism.toml reference"},
	},
}
...
var topicCategories = []struct {
	...
	{"Operations", "Runtime operations and signal handling"},
