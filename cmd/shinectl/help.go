...
func helpTopics() string {
	return `# shinectl - Available Help Topics

Use **shinectl help <topic>** to view detailed help for a specific topic.

## Available Topics

- **usage** - General usage and command-line options
- **signals** - Signal handling for reload and shutdown
- **config** - Configuration file format and loading

## Examples

View help for signals:
` + "```bash" + `
shinectl help signals
` + "```" + `

View configuration help:
` + "```bash" + `
shinectl help config
` + "```" + `
...
Configuration: ` + "`~/.config/shine/prism.toml`" + `
...
func helpList() string {
	...
	content += "Use `shinectl help <topic>` to view detailed help for a specific topic.\n"
...
func helpCategories() string {
	content := "# shinectl - Help Categories\n\n"
	...
	content += "shinectl help list\n\n"
	content += "# View detailed help for a topic\n"
	content += "shinectl help <topic>\n"
	content += "```\n"
